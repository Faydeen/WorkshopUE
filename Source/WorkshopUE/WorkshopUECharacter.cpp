...
void AWorkshopUECharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
...
bool AWorkshopUECharacter::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	...
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		...
		InputComponent->BindTouch(EInputEvent::IE_Released, this, &AWorkshopUECharacter::EndTouch);
		InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AWorkshopUECharacter::TouchUpdate);
	}
	return bResult;
}
